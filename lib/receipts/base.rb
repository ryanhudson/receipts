module Receipts
  class Base < Prawn::Document
    ...
    def render_line_items(line_items, margin_top: 30)
      ...
      table(line_items, width: bounds.width, :column_widths => [50, 180, 90, 90], cell_style: {border_color: "eeeeee", inline_format: true, ground_color: "3399FF", text_color: "FFFFFF"}) do
        cells.padding = 6
        cells.borders = []
